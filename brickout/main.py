...
class Scene_level1(Scene):
    ...
    def display(self, screen):
        ...
        self.display_player_score(screen)
        self.display_player_lives(screen)
    ...
    # Player score logic
    def display_player_score(self, screen):
        score_font = pygame.font.SysFont(available_fonts[2], 20)
        score_text = "Score: " + str(self.player_score).zfill(5)
    ...
    # Player lives logic
    def display_player_lives(self, screen):
        lives_font = pygame.font.SysFont(available_fonts[2], 20)
        lives_text = "Lives: " + str(self.player_lives).zfill(2)
